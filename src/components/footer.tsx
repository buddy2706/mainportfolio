  ...
  return (
    <footer className="flex items-center justify-between px-6 py-6 border-t text-sm text-gray-500">
      ...
      <div className="flex gap-4">
        <a href="https://github.com/buddy2706/mainportfolio" target="_blank"><Github size={18} /></a>
        <a href="https://linkedin.com/in/monicaahuja" target="_blank"><Linkedin size={18} /></a>
